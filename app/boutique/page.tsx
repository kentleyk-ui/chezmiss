    ...
    <main className="max-w-7xl mx-auto px-6 py-24 text-[#f8edf3]">
      <div className="flex items-end justify-between mb-14">
        <div>
          ...
          <h2 className="text-4xl md:text-5xl font-light text-[#B79A5B]/90 leading-tight">
            Nos<br />
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-4">
        {products.map((product, i) => (
          <article key={product.name} className="group rounded-2xl overflow-hidden border border-[#B79A5B]/[0.10] hover:border-[#B79A5B]/30 transition-all duration-500 bg-gradient-to-b from-[#0d0810] to-black">
            <div className="aspect-[3/4] relative overflow-hidden bg-gradient-to-b from-[#140c12] to-black">
              ...
              {product.tag && (
                <span className="absolute top-3 left-3 text-[9px] tracking-[0.15em] bg-[#B79A5B] text-black px-2 py-0.5 rounded-full font-semibold z-10">{product.tag}</span>
              )}
            ...
            <div className="p-4 cm-text-glass-soft">
              ...
              <div className="flex items-center justify-between">
                <span className="text-[13px] font-semibold text-[#B79A5B]">{product.price}</span>
